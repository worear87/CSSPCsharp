...
namespace CSSP
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Edge b = (from Edge e1 in region.MyGraph.Edges where e1.From.X == 1 && e1.From.Y == 1 && e1.To.X == 1 && e1.To.Y == 0 select e1).FirstOrDefault<Edge>();
            region.MyGraph.IsPathAllowed(a, b, aircraft);
        }
